      ...
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 font-sans">
        ...
        <header className="sticky top-0 z-30 h-14 flex items-center justify-between px-4 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800">
          <div className="flex items-center gap-1">
            <Link
              href={backHref}
              className="p-2 -ml-2 text-gray-400 hover:text-gray-600 dark:text-zinc-500 dark:hover:text-zinc-300 transition-colors duration-200 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800"
            >
          ...
          <div className="flex items-center pl-2 border-l border-gray-200 dark:border-zinc-800">
            ...
            <LogoutButton className="ml-3 p-2 text-gray-400 hover:text-gray-600 dark:text-zinc-500 dark:hover:text-zinc-300 transition-colors duration-200 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800" />
          </div>
        </header>
