...
import { ChevronLeft, Barcode, Camera, Plus, Minus, CheckCircle2, Loader2, AlertCircle, MapPin } from "lucide-react";
  ...
  return (
    <div className="space-y-4 py-2 flex flex-col h-full max-w-md mx-auto">
      ...
      <div className="flex-1 flex flex-col justify-between space-y-4">
        {inboundResult ? (
          /* Success Screen */
          <div className="bg-card border border-emerald-100 dark:border-emerald-950/30 rounded-xl p-6 shadow-sm flex-1 flex flex-col justify-between text-center space-y-6">
            <div className="space-y-4 my-auto">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800/40 rounded-xl p-4 border border-gray-100 dark:border-zinc-800 space-y-3">
                <div className="space-y-0.5">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-sm font-mono font-extrabold text-primary">
            ...
            <Button
              onClick={handleReset}
              size="lg"
              className="w-full h-12 rounded-xl bg-emerald-500 text-white hover:bg-emerald-600 shadow-sm text-sm shrink-0"
            >
              다음 도서 스캔
            </Button>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-between space-y-4">
            <div className="bg-card border border-border rounded-xl p-5 shadow-sm space-y-4">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2.5 text-sm font-mono bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-800 rounded-xl focus:border-primary focus:outline-none dark:text-zinc-100 transition-colors duration-200"
                    />
              ...
              {bookInfo && (
                <div className="bg-primary/5 border border-primary/15 rounded-xl p-4 space-y-3 animate-fadeIn">
                  <div className="space-y-0.5">
                  ...
                  <div className="border-t border-dashed border-primary/20 pt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="flex gap-1 mr-1">
                        <button
                          ...
                          className="px-1.5 py-1 text-[10px] font-bold bg-rose-50 dark:bg-rose-950/20 text-rose-600 dark:text-rose-400 border border-rose-100 dark:border-rose-950/20 rounded-lg hover:bg-rose-100 dark:hover:bg-rose-950/40 transition-colors duration-200 cursor-pointer"
                        >
                          -10
                        </button>
                        <button
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-border bg-card flex items-center justify-center text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors duration-200 cursor-pointer"
                      >
                      ...
                      <div className="flex gap-1 ml-1">
                        <button
                          ...
                          className="px-1.5 py-1 text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 rounded-lg hover:bg-primary/15 transition-colors duration-200 cursor-pointer"
                        >
                          +5
                        </button>
                        <button
            ...
            <Button
              ...
              size="lg"
              className="w-full h-12 rounded-xl text-sm shrink-0"
            >
              {isSubmitting ? (
                <>
